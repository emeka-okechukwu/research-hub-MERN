...
const AllPublishedResearch: React.FC = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKEND_URL}/research/all/published`, {
      method: 'GET',
      headers: {
    ...
    <div>
      ...
      <div className='container mt-1'>
        <h2 style={{ color: '#923D41' }}>
          <span className='fa fa-check-double'></span> All Published Research
        </h2>
        <br />
              ...
              <table className='table table-hover table-sm custom-table'>
                ...
                <tbody>
                  {currentItems.map((research) => (
                    <tr key={research._id}>
                      <td width='1%'>
                        <Link to={`/view-published-research/${research._id}`}>
...
export default AllPublishedResearch
