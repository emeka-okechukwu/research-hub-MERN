...
const InviteResearcher: React.FC = () => {
  ...
  useEffect(() => {
    fetch(
      `${process.env.REACT_APP_BACKEND_URL}/users/researcher/other-researchers`,
      {
        method: 'GET',
        headers: {
    ...
    <div>
      ...
      <div className='container mt-1'>
        <h2 style={{ color: '#923D41' }}>
          <span className='fas fa-user-plus'></span> Invite Researcher
        </h2>
        <br />
